                    ...
                    <div>
                        <form action="#" method="POST" id="recurringForm">
                            ...
                            <div id="recurHidden">
                                ...
                                <p>Event repeats every</p> <input id="every" type="number" min="0" value="1" SIZE="3" width="5px"> <select id="defineEvery" class="prioritycmb" type="text" name="cmbDefineEvery" value="">
                                    <option>days</option>
                                    <option>weeks</option>
                                    <option>months</option>
                                </select>
                                <p>on days</p>
                                <input type="checkbox" id="sun" name="chbMon"> <input type="checkbox" id="mon" name="chbMon"> <input type="checkbox" id="tue" name="chbMon"> <input type="checkbox" id="wed" name="chbMon"> <input type="checkbox" id="thurs" name="chbMon"> <input type="checkbox" id="fri" name="chbMon"> <input type="checkbox" id="sat" name="chbMon">
                                <p> S    M    T    W    T    F    S </p>
                            </div>
                            <script>
                                $(function () {

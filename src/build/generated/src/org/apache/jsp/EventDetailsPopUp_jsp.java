...
subjectColour = "#00FFFF";
      ...
      out.write("                                    <input type=\"time\" id=\"appt-time\" name=\"startTime\"\r\n");
      out.write("                                           min=\"9:00\" max=\"18:00\" required />\r\n");
      out.write("                                </div>\r\n");
      out.write("                                <h3>&nbsp;</h3>\r\n");
      out.write("\r\n");
      out.write("                                <div>\r\n");
      ...
      out.write("                                    <div class=\"control\">\r\n");
      out.write("                                        <label for=\"appt-time\">Time:</label>\r\n");
      out.write("                                        <input type=\"time\" id=\"appt-time\" name=\"endTime\"\r\n");
      out.write("                                               min=\"9:00\" max=\"18:00\" required />\r\n");
      out.write("                                    </div>\r\n");
      out.write("                                    <h3>&nbsp;</h3>\r\n");
      out.write("                                </div>    \r\n");
      ...
      out.write("                                <div>\r\n");
      out.write("\r\n");
      out.write("                                    <form action=\"#\" method=\"POST\" id=\"recurringForm\">\r\n");
      out.write("                                        <div>\r\n");
      out.write("                                            <input type=\"checkbox\" id=\"trigger\" name=\"question\"> Recurring\r\n");
      out.write("                                        </div>\r\n");
      out.write("\r\n");
      out.write("                                        <p id=\"recurringText\">Event repeats every</p> <input id=\"every\" type=\"number\" min=\"0\" value=\"1\" SIZE=\"3\" width=\"5px\"> <select id=\"defineEvery\" class=\"prioritycmb\" type=\"text\" name=\"cmbDefineEvery\" value=\"\">\r\n");
      out.write("                                            <option>days</option>\r\n");
      out.write("                                            <option>weeks</option>\r\n");
      out.write("                                            <option>months</option>\r\n");
      out.write("                                        </select>\r\n");
      out.write("                                        <p id=\"onDays\">on days</p>\r\n");
      out.write("                                        <p id=\"daysText\"><input type=\"checkbox\" id=\"sun\" name=\"chbMon\"> <input type=\"checkbox\" id=\"mon\" name=\"chbMon\"> <input type=\"checkbox\" id=\"tue\" name=\"chbMon\"> <input type=\"checkbox\" id=\"wed\" name=\"chbMon\"> <input type=\"checkbox\" id=\"thurs\" name=\"chbMon\"> <input type=\"checkbox\" id=\"fri\" name=\"chbMon\"> <input type=\"checkbox\" id=\"sat\" name=\"chbMon\"></p>\r\n");
      out.write("                                        <p id=\"daysLabel\"> S    M    T    W    T    F    S </p>\r\n");
      out.write("                                        <script>\r\n");
      out.write("                                            $(function () {\r\n");
      out.write("                                                var checkbox = $(\"#trigger\");\r\n");
      out.write("                                                var hidden = $(\"#recurringText\");\r\n");
      out.write("                                                var populate = $(\"#every\");\r\n");
      out.write("                                                var defineEvery = $(\"#defineEvery\");\r\n");
      out.write("                                                var daysText = $(\"#daysText\");\r\n");
      out.write("                                                var daysLabel = $(\"#daysLabel\");\r\n");
      out.write("                                                var mon = $(\"#mon\");\r\n");
      out.write("                                                var tue = $(\"#tue\");\r\n");
      out.write("                                                var wed = $(\"#wed\");\r\n");
      out.write("                                                var thurs = $(\"#thurs\");\r\n");
      out.write("                                                var fri = $(\"#fri\");\r\n");
      out.write("                                                var sat = $(\"#sat\");\r\n");
      out.write("                                                var sun = $(\"#sun\");\r\n");
      out.write("                                                var onDays = $(\"#onDays\");\r\n");
      out.write("                                                hidden.hide();\r\n");
      out.write("                                                populate.hide();\r\n");
      out.write("                                                defineEvery.hide();\r\n");
      out.write("                                                populate.hide();\r\n");
      out.write("                                                defineEvery.hide();\r\n");
      out.write("                                                daysText.hide();\r\n");
      out.write("                                                daysLabel.hide();\r\n");
      out.write("                                                mon.hide();\r\n");
      out.write("                                                tue.hide();\r\n");
      out.write("                                                wed.hide();\r\n");
      out.write("                                                thurs.hide();\r\n");
      out.write("                                                fri.hide();\r\n");
      out.write("                                                onDays.hide();\r\n");
      out.write("                                                checkbox.change(function () {\r\n");
      out.write("                                                    if (checkbox.is(':checked')) {\r\n");
      out.write("                                                        hidden.show();\r\n");
      out.write("                                                        populate.show();\r\n");
      out.write("                                                        defineEvery.show();\r\n");
      out.write("                                                        daysText.show();\r\n");
      out.write("                                                        daysLabel.show();\r\n");
      out.write("                                                        mon.show();\r\n");
      out.write("                                                        tue.show();\r\n");
      out.write("                                                        wed.show();\r\n");
      out.write("                                                        thurs.show();\r\n");
      out.write("                                                        fri.show();\r\n");
      out.write("                                                        sat.show();\r\n");
      out.write("                                                        sun.show();\r\n");
      out.write("                                                        onDays.show();\r\n");
      out.write("                                                        //populate.val(\"Dude, this input got populated!\");\r\n");
      out.write("                                                    } else {\r\n");
      out.write("                                                        hidden.hide();\r\n");
      out.write("                                                        populate.hide();\r\n");
      out.write("                                                        defineEvery.hide();\r\n");
      ...
      out.write("                                        <div>\r\n");
      out.write("                                            <input type=\"checkbox\" id=\"trigger\" name=\"question\"> Auto-fill Tasks\r\n");
      out.write("                                        </div>\r\n");
      out.write("\r\n");
      out.write("                                        <p id=\"recurringText\">Event repeats every</p> <input id=\"every\" type=\"number\" min=\"0\" value=\"1\" SIZE=\"3\" width=\"5px\"> <select id=\"defineEvery\" class=\"prioritycmb\" type=\"text\" name=\"cmbDefineEvery\" value=\"\">\r\n");
      out.write("                                            <option>days</option>\r\n");
